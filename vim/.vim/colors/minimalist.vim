...
hi CursorLine       ctermfg=NONE    ctermbg=237     cterm=NONE      guifg=NONE          guibg=#121212   gui=NONE
...
hi Pmenu            ctermfg=255     ctermbg=239     cterm=NONE      guifg=#EEEEEE       guibg=#4E4E4E   gui=NONE
...
hi Visual           ctermfg=239     ctermbg=117     cterm=NONE      guifg=#4E4E4E       guibg=#87D7FF   gui=NONE
"hi Visual           ctermfg=NONE    ctermbg=NONE    cterm=reverse   guifg=#4E4E4E       guibg=#87D7FF   gui=NONE
...
hi SpellBad         ctermfg=255     ctermbg=167     cterm=inverse      guifg=#EEEEEE       guibg=#D75F5F   gui=undercurl
hi SpellCap         ctermfg=255     ctermbg=74      cterm=inverse      guifg=#EEEEEE       guibg=#5FAFD7   gui=undercurl
hi SpellRare        ctermfg=255     ctermbg=140     cterm=inverse      guifg=#EEEEEE       guibg=#AF87D7   gui=undercurl
hi SpellLocal       ctermfg=255     ctermbg=14      cterm=inverse      guifg=#EEEEEE       guibg=#5FB3B3   gui=undercurl
...
hi debugPC                          ctermbg=20  " Current line in vim-dap
...
hi javaConceptKind      ctermfg=gray    ctermbg=NONE    cterm=NONE                                                   " Java
