...
let g:markdown_fenced_languages = ['py=python', 'python', 'bzl', 'c', 'cpp', 'hare', 'sh', 'bash=sh', 'rcshell', 'html', 'toml', 'vim', 'yaml']
...
autocmd FileType janet   let b:gutentags_ctags_extra_args = ['--languages=Janet']
