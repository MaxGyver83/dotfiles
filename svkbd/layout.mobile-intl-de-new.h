...
static Key keys_de[KEYS] = {
	{ "Esc", "", XK_Escape, 1 },
	{ "!", "1", XK_1, 1, XK_Shift_L },
	{ "?", "ß", XK_ssharp, 1, XK_Shift_L },
	{ "\\","ß", XK_ssharp, 1, XK_ISO_Level3_Shift },
	{ "|", "<", XK_less, 1, XK_ISO_Level3_Shift },
	{ "(", "8", XK_8, 1, XK_Shift_L },
	{ ")", "9", XK_9, 1, XK_Shift_L },
	{ "\"","2", XK_2, 1, XK_Shift_L },
	{ "'", "#", XK_numbersign, 1, XK_Shift_L },
...
// When a key is clicked with the middle mouse button,
// it's like holding AltGr.
// Clicking with the right mouse button is like Shift+key.
Buttonmod buttonmods[] = {
	{ XK_ISO_Level3_Shift, Button2 },
	{ XK_Shift_L, Button3 },
};
